<div class="app-sidebar sidebar-shadow">
    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            ...
            $isExamPage = isset($_GET['page']) && $_GET['page'] === 'exam';
            if ($isExamPage) {
                echo '<div class="alert alert-warning m-3" role="alert">
                    <i class="fa fa-exclamation-triangle"></i> Sidebar is disabled during exam
                </div>';
            }
            ?>
            <ul class="vertical-nav-menu" <?php echo $isExamPage ? 'style="pointer-events: none; opacity: 0.6;"' : ''; ?>>
